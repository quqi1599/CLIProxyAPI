...
func TestUsageQueuePluginPayloadIncludesStableFieldsAndSuccess(t *testing.T) {
	withEnabledQueue(t, func() {
		...
		requireStringField(t, payload, "endpoint_method", "POST")
		requireStringField(t, payload, "endpoint_path", "/v1/chat/completions")
...
func TestUsageQueuePluginPayloadIncludesStableFieldsAndFailureAndGinRequestID(t *testing.T) {
	withEnabledQueue(t, func() {
		...
		requireStringField(t, payload, "endpoint_method", "GET")
		requireStringField(t, payload, "endpoint_path", "/v1/responses")
		requireStringField(t, payload, "auth_type", "apikey")
		requireMissingField(t, payload, "user_api_key")
