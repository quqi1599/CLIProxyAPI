...
type ContentAuditConfig struct {
	...
	// EducationDocumentTokenIDs enables document-material semantics for verified tokens.
	// The list is server-side configuration; client-provided profile headers are not trusted.
	EducationDocumentTokenIDs []int64                       `yaml:"education-document-token-ids,omitempty" json:"-"`
...
type OpenAICompatibility struct {
	...
	// Kind selects a built-in compatibility profile (for example: kimi, minimax, qwen, xiaomi, zhipu, doubao, xfyun, maas, langengyun, newapi).
...
type OpenAICompatibilityModel struct {
	...
	// Built-in compatibility profiles may override this for provider-specific models.
