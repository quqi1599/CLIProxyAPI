...
func TestLogFormatterIncludesCompatAndStreamObservabilityFields(t *testing.T) {
	entry := &log.Entry{
		...
		Data: log.Fields{
			...
			"compat_kind":                   "doubao",
			"compat_kind_source":            "auth_attribute:compat_kind",
			"compat_mapping":                "deepseek_v4_via_doubao_volcengine",
			"requested_model":               "MiniMax-M3",
			"upstream_model":                "MiniMax-M3",
			"request_path":                  "/v1/chat/completions",
			"time_to_first_chunk_ms":        3512,
			"upstream_chunk_wait_ms":        147200,
			"upstream_chunk_wait_count":     1883,
			"stream_duration_ms":            183000,
			"total_duration_ms":             186512,
			"downstream_write_ms":           841,
			"downstream_write_calls":        1885,
			"downstream_flush_ms":           219,
			"downstream_flush_calls":        1885,
			"chunks_count":                  1884,
			"bytes_out":                     928331,
			"stream_output_tokens":          4096,
			"stream_output_tokens_observed": true,
			"output_tokens":                 4096,
