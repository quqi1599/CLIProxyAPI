...
var logFieldOrder = []string{
	...
	"selection_reason", "routing_phase", "candidate_count", "candidate_ready_count", "candidate_health_downweighted", "candidate_health_deferred",
	"candidate_skipped_disabled", "candidate_skipped_cooldown", "candidate_skipped_breaker", "candidate_skipped_unavailable",
	"candidate_skipped_compatibility", "excluded_candidate_count",
	...
	"retry_permit_acquired", "retry_permit_rejected", "retry_permit_fail_open", "retry_permit_queued",
	...
	"first_event_wait_budget_ms", "first_event_wait_budget_exhausted", "retry_admission_wait_budget_ms",
	...
	"terminal_outcome", "summary_phase", "http_status",
