...
const contentAuditReviewOutputSchema = `{
  ...
  "properties": {
    ...
    "category": {"type": "string", "enum": ["jailbreak", "csam", "weapons", "extremism", "drugs", "criminal", "fraud", "cyber", "piracy", "gambling", "sexual", "self_harm", "violence", "political", "none", "unknown"]},
